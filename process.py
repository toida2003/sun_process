...
class Sun:
    def __init__(
        ...
        self.img = {}
        self.img["color"] = color_img
        self.img["binary"] = bin_img
        self.size: tuple(int, int) = size
        self.sunspots: list[Sunspot] = []
        self.sunspots_norm: list[Sunspot] = []
        self.img["drawn_sunspots_img"]: np.ndarray = color_img.copy()

    def SetImage(self, key: str, img: np.ndarray):
        self.img[key] = img

    def GetImage(self, key: str) -> np.ndarray:
        return self.img[key]
    ...
    def GetDrawnSunpotsImage(self) -> np.ndarray:
        return self.img["drawn_sunspots_img"]
